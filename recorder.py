...
import argparse, datetime, logging, math, os, os.path, random, re, sys, csv
...
class Recorder(QObject):
    ...
    def finishRecording(self):
        ...
        filename = os.path.normpath(os.path.join(self.window.property('saveDir'), "recorder_" + TIME + ".wav"))
